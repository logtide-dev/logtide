...
- **Row density toggle in log search** (UX audit): a Cozy/Compact toggle in the table toolbar tightens row padding for scanning more logs at once, persisted in localStorage. (Custom columns were already persisted per project.)
